...
import {credit_report_accountsInstance, credit_report_accountsAttribute} from './db';

module.exports = function(sequelize: sequelize.Sequelize, DataTypes: DataTypes) {
  return sequelize.define<credit_report_accountsInstance, credit_report_accountsAttribute>('credit_report_accounts', {
    id: {
